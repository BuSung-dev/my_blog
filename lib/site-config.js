export const profile = {
  ...
  focus: "I’m highly interested in web vulnerabilities, but I also enjoy other fields.",
  writingPrinciples: "I aim to write records that enable reproducible analysis.",
  education: [
