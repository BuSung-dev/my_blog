export const profile = {
  name: "BuSung (Baek Bu Seung)",
  avatar: "B",
  shortBio: "공격 관점의 보안 연구를 기록하는 블로그입니다.",
  bio: "리버스 엔지니어링, 시스템 내부 구조, 웹 취약점, 실전형 취약점 분석을 중심으로 공부하고 있습니다. 이 블로그에는 다시 찾아볼 만한 분석 기록, 워크스루, 실험 메모를 정리합니다.",
  focus: "리버스 엔지니어링, 취약점 분석, 웹 보안, 시스템 내부 구조, CTF 및 기술 문서화",
  writingPrinciples: "재현 가능한 분석, 이해 과정이 남는 기록, 나중에 다시 봐도 바로 이어서 읽을 수 있는 글을 지향합니다.",
  education: [
  ...
  awards: [
    {
      ...
      entries: [
        ...
        "2025.11.21 | 화이트햇 콘테스트 2025 - 장려상",
        "2025.11.14 | POC CTF 2025 - 2등",
        "2025.09.23 | 제5회 WooriCON 모의해킹 경진대회 - 최우수상(2등)",
