export const profile = {
  ...
  education: [
    "2023.07-2024.03 | Best of the Best 12th, Vulnerability Analysis Track",
    "2024.04-2025.01 | Daegu University Information Security Gifted Program, Advanced High School Course",
    "2025.03-present | Soongsil University Information Security"
  ],
  hallOfFame: [
  ...
  awards: [
    {
      year: "2025",
      entries: [
        "2025.11.14 | SecureX Challenge - COSS Council Chair Award",
        "2025.11.23 | 2025 LISAthon: Mobility Competition - Encouragement Award",
        "2025.11.21 | WhiteHat Contest 2025 - Encouragement Award",
        "2025.11.14 | POC CTF 2025 - 2nd Place",
        "2025.09.23 | 5th WooriCON Mock Hacking Competition - Excellence Award (2nd)",
        "2025.09.18 | 6th Honam Cyber Security Conference Web Vulnerability Competition - Excellence Award (1st)",
        "2025.07.17 | Hacksium Busan 2025 - Excellence Award (3rd)"
      ]
    },
    {
      year: "2024",
...
export function getSiteMetadata() {
  ...
  return {
    title: profile.name,
    tagline: "개인 블로그",
    description: "기록하려고 만든 개인 블로그입니다.",
    keywords: [
      // "Next.js blog",
      // "GitHub Pages",
      // "Markdown blog",
